...
const sources: SourceInfo[] = [
  { id: 1, name: 'Codex', sourceKind: 'codex_jsonl', dataCapability: 'metrics', rootPath: '~/.codex', enabled: true, available: true, fileCount: 546, totalBytes: 2_577_980_416, lastScanAt: iso(-2), error: null },
...
const matrix: ModelEffortStat[] = [
  ...
  { sourceId: 4, sourceName: 'DSH', provider: 'OpenAI', model: 'gpt-5.6-terra', reasoningEffort: 'high', observationCount: 15, averageTtftMs: 702, averageEffectiveTps: 19.8, tokens: tokenSet(51_200, 210_400, 0, 33_800, 9_400), estimatedCostNanoUsd: 824_000_000, pricing: { pricedObservations: 15, totalObservations: 15, pricedTokens: 295_400, totalTokens: 295_400, ratio: 1, complete: true } },
  { sourceId: 6, sourceName: 'EvoX', provider: 'omlx', model: 'Qwen3.8-27B-MLX-4bit', reasoningEffort: 'default', observationCount: 18, averageTtftMs: null, averageEffectiveTps: null, tokens: tokenSet(45_200, 72_100, 0, 24_900, 6_200), estimatedCostNanoUsd: 0, pricing: { pricedObservations: 18, totalObservations: 18, pricedTokens: 142_200, totalTokens: 142_200, ratio: 1, complete: true } },
]
...
let mockStatus: ImportStatus = { running: false, paused: false, filesDone: 596, filesTotal: 596, bytesDone: 2_656_518_758, bytesTotal: 2_656_518_758, currentFile: null, startedAt: iso(-48), message: '本机指标均已同步' }
let mockAutostart = false
let mockSettings: AppSettings = { menuMetrics: { todayTokens: true, ttft: false, effectiveTps: false, estimatedCost: false }, menuPeriod: 'realtime', activeSourceKind: null, updates: { automaticCheck: true, lastCheckedAt: null } }
